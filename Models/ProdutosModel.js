...
const getProdutos = async()=>{
    ...
    const result = await pool.request().query("SELECT nomeproduto, descricao, preco, Categorias.categoria FROM Produtos inner join Categorias on Produtos.id_categoria = Categorias.id_categoria")
